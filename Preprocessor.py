...
def get_full_mds():
    ...
    # Select Columns
    mds = mds[[ 'Market', 'DayIndex', 'Open', 'High', 'Low', 'Close', 'Volume', 'ATR10']]
    ...
    mds['OpenMA10'] = (mds['Open'] - mds['Open'].rolling(window=10,center=False).mean())/mds['ATR10']
    mds['OpenMA30'] = (mds['Open'] - mds['Open'].rolling(window=30,center=False).mean())/mds['ATR10']
    mds['OpenMA50'] = (mds['Open'] - mds['Open'].rolling(window=50,center=False).mean())/mds['ATR10']
...
def get_scaled_mds():
    mds = get_full_mds()
    mds = mds[['Market', 'DayIndex', 'Gap', 'YChange', 'YRange', 'OpenMA10', 'OpenMA30', 'OpenMA50', 'ATR10','Up']]
    return mds
